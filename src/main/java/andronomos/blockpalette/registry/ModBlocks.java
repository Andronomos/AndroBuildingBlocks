...
public class ModBlocks {
	...
	public static final RegistryObject<StairBlock> ROUGH_CYAN_CONCRETE_STAIRS = registerStairBlock("rough_cyan_concrete_stairs", ROUGH_CYAN_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.CYAN));
	public static final RegistryObject<SlabBlock> ROUGH_CYAN_CONCRETE_SLAB = registerSlabBlock("rough_cyan_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.CYAN));
	public static final RegistryObject<WallBlock> ROUGH_CYAN_CONCRETE_WALL = registerWallBlock("rough_cyan_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.CYAN));
	...
	public static final RegistryObject<StairBlock> ROUGH_LIGHT_BLUE_CONCRETE_STAIRS = registerStairBlock("rough_light_blue_concrete_stairs", ROUGH_LIGHT_BLUE_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_BLUE));
	public static final RegistryObject<SlabBlock> ROUGH_LIGHT_BLUE_CONCRETE_SLAB = registerSlabBlock("rough_light_blue_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_BLUE));
	public static final RegistryObject<WallBlock> ROUGH_LIGHT_BLUE_CONCRETE_WALL = registerWallBlock("rough_light_blue_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_BLUE));
	...
	public static final RegistryObject<StairBlock> ROUGH_LIGHT_GRAY_CONCRETE_STAIRS = registerStairBlock("rough_light_gray_concrete_stairs", ROUGH_LIGHT_GRAY_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_GRAY));
	public static final RegistryObject<SlabBlock> ROUGH_LIGHT_GRAY_CONCRETE_SLAB = registerSlabBlock("rough_light_gray_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_GRAY));
	public static final RegistryObject<WallBlock> ROUGH_LIGHT_GRAY_CONCRETE_WALL = registerWallBlock("rough_light_gray_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.LIGHT_GRAY));
	...
	public static final RegistryObject<StairBlock> ROUGH_LIME_CONCRETE_STAIRS = registerStairBlock("rough_lime_concrete_stairs", ROUGH_LIME_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.LIME));
	public static final RegistryObject<SlabBlock> ROUGH_LIME_CONCRETE_SLAB = registerSlabBlock("rough_lime_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.LIME));
	public static final RegistryObject<WallBlock> ROUGH_LIME_CONCRETE_WALL = registerWallBlock("rough_lime_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.LIME));
	...
	public static final RegistryObject<StairBlock> ROUGH_MAGENTA_CONCRETE_STAIRS = registerStairBlock("rough_magenta_concrete_stairs", ROUGH_MAGENTA_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.MAGENTA));
	public static final RegistryObject<SlabBlock> ROUGH_MAGENTA_CONCRETE_SLAB = registerSlabBlock("rough_magenta_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.MAGENTA));
	public static final RegistryObject<WallBlock> ROUGH_MAGENTA_CONCRETE_WALL = registerWallBlock("rough_magenta_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.MAGENTA));
	...
	public static final RegistryObject<StairBlock> ROUGH_PINK_CONCRETE_STAIRS = registerStairBlock("rough_pink_concrete_stairs", ROUGH_PINK_CONCRETE, CONCRETE_PROPERTIES.mapColor(DyeColor.PINK));
	public static final RegistryObject<SlabBlock> ROUGH_PINK_CONCRETE_SLAB = registerSlabBlock("rough_pink_concrete_slab", CONCRETE_PROPERTIES.mapColor(DyeColor.PINK));
	public static final RegistryObject<WallBlock> ROUGH_PINK_CONCRETE_WALL = registerWallBlock("rough_pink_concrete_wall", CONCRETE_PROPERTIES.mapColor(DyeColor.PINK));
