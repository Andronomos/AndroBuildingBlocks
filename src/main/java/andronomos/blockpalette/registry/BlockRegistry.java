...
public class BlockRegistry {
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_WHITE_TILE = registerBlock("rough_concrete_white_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.WHITE));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_BLUE_TILE = registerBlock("rough_concrete_blue_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.BLUE));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_BLACK_TILE = registerBlock("rough_concrete_black_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.BLACK));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_BROWN_TILE = registerBlock("rough_concrete_brown_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.BROWN));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_GREEN_TILE = registerBlock("rough_concrete_green_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.GREEN));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_GRAY_TILE = registerBlock("rough_concrete_gray_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.GRAY));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_ORANGE_TILE = registerBlock("rough_concrete_orange_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.ORANGE));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_PURPLE_TILE = registerBlock("rough_concrete_purple_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.PURPLE));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_RED_TILE = registerBlock("rough_concrete_red_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.RED));
	...
	public static final RegistryObject<Block> ROUGH_CONCRETE_YELLOW_TILE = registerBlock("rough_concrete_yellow_tile", CONCRETE_PROPERTIES.mapColor(DyeColor.YELLOW));
